...
const Signup = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row justify-center items-center min-h-screen h-max bg-[#F3F3F5]">
            <div className="flex items-center justify-center w-full h-full md:h-full py-20 md:py-0">
