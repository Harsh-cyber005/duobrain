...
export default function ShareHero() {
    ...
    return (
        <div className="bg-background min-h-screen h-auto w-full ml-0 xs:ml-[96px] lg:ml-[300px]">
            <div className="xxs:p-10 p-5 h-full">
                {
                    !error &&
                ...
                {
                    error && <div className=" h-full text-2xl mt-5 stroke-[5px] px-20 pt-10 flex flex-col justify-start items-start">
                        <div className="hidden xs:flex justify-center items-center gap-2 duration-200">
                            <h1 onClick={() => {
                                router.push("/dashboard")
                            }} className="text-lg font-semibold cursor-pointer flex text-red-700 bg-red-200 px-3 py-1 rounded-md">Link invalid or expired</h1>
                            <h1 className="text-lg font-semibold flex select-none">/</h1>
                            <Button onClick={() => {
                                router.push("/dashboard")
                            }} variant="primary" size="crumb" text="go back" startIcon={<BackIcon size="sm" />} />
                        </div>
                    </div>
                }
            </div>
